...
Date initiale : 2026-05-21 · Dernière mise à jour : 2026-05-26 (V15)
...
| **V16+** | Cf. plan section 8 — non démarrées (BUG-005 Pinel éligibilité [bloqué P7 surface en DB], INTEG-007 réversibilité révision loyer [décision produit], autres kinds alerte vacancy / sinistre / credit_ending_soon / under_rent, décisions produit foncier MaPrimeRénov / LMP déficit amort / agrégation foyer / MH/Malraux à brancher au moteur, 6 frictions UX P3 restantes) | ⏳ À venir | — |

**Total items traités à ce jour** : **35/41** (P1: 11/11 — ROB-001/002/003 + BUG-002/003 + INTEG-001/002 + BUG-007/008 + BUG-001 + BUG-004 + BUG-006 + CAS-DASH-001/INTEG-003 + CAS-RP-001 ; P2: 18/19 — régen types + BUG-009 + INTEG-005/006 + BUG-D1-M01 + BUG-D1-M02 + BUG-D1-M08 + BUG-D1-M03 + BUG-D1-M04 + BUG-D1-M05 + BUG-D1-M06 + ROB-101/102/103/104/105/106/107 + CAS-WIZ-LOT-001 ; FRICTION: 4/10 — FRICTION-001 + FRICTION-003 + FRICTION-005 + FRICTION-008 ; PDF: 1/1 — annexe dette technique V14) + **2 nettoyages UI V13 (MH option fantôme désactivée + garde-fou Pinel clos 2025)** · **≥161 nouveaux tests** ajoutés (V1–V14, V15 = 0 nouveau test car changements purement présentationnels — 1521 tests existants tous verts).
