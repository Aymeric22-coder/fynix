...
Date initiale : 2026-05-21 · Dernière mise à jour : 2026-05-26 (V11)
...
| **V12+** | Cf. plan section 8 — non démarrées (BUG-005 Pinel éligibilité [bloqué P7 surface en DB], INTEG-007 réversibilité révision loyer [décision produit], autres kinds alerte vacancy / sinistre / credit_ending_soon / under_rent, décisions produit foncier MaPrimeRénov / LMP déficit amort / agrégation foyer / MH / Pinel clos 2025) | ⏳ À venir | — |

**Total items traités à ce jour** : **30/41** (P1: 10/11 — ROB-001/002/003 + BUG-002/003 + INTEG-001/002 + BUG-007/008 + BUG-001 + BUG-004 + BUG-006 + **CAS-DASH-001/INTEG-003** ; P2: 17/19 — régen types + BUG-009 + INTEG-005/006 + BUG-D1-M01 + BUG-D1-M02 + BUG-D1-M08 + BUG-D1-M03 + BUG-D1-M04 + BUG-D1-M05 + BUG-D1-M06 + ROB-101/102/103/104/105/106/107 ; FRICTION: 1/10 — FRICTION-001) · **≥127 nouveaux tests** ajoutés (V1–V10.1 + 25 V11 : 18 helper property-alerts filtrage/sévérité/agrégation/totalEur positif/bornes seuils strictes inclusives, 7 portfolio-summary kind:unpaid_rent message singulier/pluriel/labels temporels/tri par sévérité/under_rent désactivé).
