...
Date initiale : 2026-05-21 · Dernière mise à jour : 2026-05-26 (V12)
...
| **V13+** | Cf. plan section 8 — non démarrées (BUG-005 Pinel éligibilité [bloqué P7 surface en DB], INTEG-007 réversibilité révision loyer [décision produit], autres kinds alerte vacancy / sinistre / credit_ending_soon / under_rent, décisions produit foncier MaPrimeRénov / LMP déficit amort / agrégation foyer / MH / Pinel clos 2025) | ⏳ À venir | — |

**Total items traités à ce jour** : **32/41** (P1: 11/11 — ROB-001/002/003 + BUG-002/003 + INTEG-001/002 + BUG-007/008 + BUG-001 + BUG-004 + BUG-006 + CAS-DASH-001/INTEG-003 + **CAS-RP-001** ; P2: 18/19 — régen types + BUG-009 + INTEG-005/006 + BUG-D1-M01 + BUG-D1-M02 + BUG-D1-M08 + BUG-D1-M03 + BUG-D1-M04 + BUG-D1-M05 + BUG-D1-M06 + ROB-101/102/103/104/105/106/107 + **CAS-WIZ-LOT-001** ; FRICTION: 1/10 — FRICTION-001) · **≥144 nouveaux tests** ajoutés (V1–V11 + 17 V12 : `isRentalWizardUsage` true/false sur 5 usages + null/undefined/inconnu, `wizardStepsFor` 5 vs 4 étapes + cohérence 3 premières étapes partagées, `requiresFiscalRegimeStep`).
